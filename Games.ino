/* LINES YOU NEED TO EDIT {
  L:33 TO L:42 IF YOU CHANGED THE WIRING aka {
...
#include <WiFi.h> // this library is for connecting to wifi
#include <Arduino.h> // this library is for basic arduino functions
#include <stdio.h> // this library is for funzies

//=== VARIABLES: ===//

//=== PINS: ===//

int led_pin = 13; // this led pin is used to tell you if your device is connected to server or not
int button_a = 12; // this val is for pin to  button a
int button_b = 14; // this val is for pin to button b
int button_c = 15; // this val is for pin to button c
int button_d = 18; // this val is for pin to button d
int button_e = 19; // this val is for pin to button e YOU CAN IGNORE THIS IF YOU DONT HAVE A BUTTON E
int button_f = 21; // this val is for pin to button f YOU CAN IGNORE THIS IF YOU DONT HAVE A BUTTON F
int xpin = 34; // this val is for pin to joysticks x axis
int ypin = 35; // this val is for pin to joysticks y axis
